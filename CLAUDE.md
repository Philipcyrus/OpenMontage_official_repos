...
[`AGENT_GUIDE.md`](AGENT_GUIDE.md) before responding to a user message.**
...
Apart from the leg section above, there are no instructions in this file. All instructions are
in AGENT_GUIDE.md.
