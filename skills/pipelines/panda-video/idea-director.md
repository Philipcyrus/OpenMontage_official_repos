...
- **Providers:** visuals via the Higgsfield MCP; voice/music via ElevenLabs. Note any provider
...
(narration, music, captions, brand cards), `missing_capabilities`, `fallback_policy`.
